	...
	<div>
		<div class="register-container">
			<el-form v-if="pageFlag=='register'" ref="ruleForm" class="rgs-form animate__animated animate__" :model="ruleForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">明泰配件加工厂工单管理系统</div>
					...
					<el-form-item class="list-item" v-if="tableName=='shangjia'">
						<div class="lable" :class="changeRules('shangjiadizhi')?'required':''">商家地址：</div>
					...
					<el-form-item class="list-item" v-if="tableName=='shangjia'">
						<div class="lable" :class="changeRules('touxiang')?'required':''">营业执照：</div>
						<file-upload
							tip="点击上传营业执照"
							action="file/upload"
							:limit="3"
